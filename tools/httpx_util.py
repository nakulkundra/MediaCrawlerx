...
def make_async_client(**kwargs) -> httpx.AsyncClient:
    """Create uniformly configured httpx.AsyncClient.

    Reads DISABLE_SSL_VERIFY from configuration file (default False, meaning SSL verification is enabled).
    Only needs to be set to True when using enterprise proxy, Burp, mitmproxy, etc. man-in-the-middle proxies.
    """
