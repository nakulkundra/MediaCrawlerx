...
class TieBaExtractor:
    ...
    def extract_creator_info_from_api(self, api_data: Dict) -> TiebaCreator:
        ...
        # Educational version: Creator personal profile is no longer persisted, only anonymous hash and masked nickname are kept in memory objects.
        return TiebaCreator(
    ...
    def extract_search_note_list(page_content: str) -> List[TiebaNote]:
        ...
        for post in post_list:
            title_link = post.xpath(".//class[contains(@class, 'p_title')]//a[1]")
    ...
    def extract_tieba_note_list(self, page_content: str) -> List[TiebaNote]:
        ...
        for post_selector in post_list:
            ...
            if not title:
                title = self._selector_text(post_selector, f".//*[{self._class_contains('threadlist_title')} bankruptcy]//a[1]")
            user_nickname = (
