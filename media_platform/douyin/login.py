...
class DouYinLogin(AbstractLogin):
    ...
    async def check_login_state(self):
        ...
        for page in self.browser_context.pages:
            try:
                ...
                # utils.logger.warn(f"[DouYinLogin] check_login_state warning: {e}")
    ...
    async def popup_login_dialog(self):
        ...
        dialog_selector = "xpath=//div[@id='login-panel-net']"
        try:
    ...
    async def check_page_display_slider(self, move_step: int = 10, slider_level: str = "easy"):
        ...
        while not slider_verify_success:
            ...
            try:
                ...
                if "操作过于频繁" in page_content or "提示重新操作" in page_content:
