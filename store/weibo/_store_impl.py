...
def _filter_model_fields(model_cls, item: Dict) -> Dict:
    """Only keep columns that exist in the target ORM model to avoid errors when passing deleted/extra fields (such as avatar/gender/profile_url/ip_location/user_id) to the ORM constructor. Educational version fallback protection."""
...
class WeiboCsvStoreImplement(AbstractStore):
    ...
    async def store_creator(self, creator: Dict):
        ...
        Educational version: Do not collect/persist creator personal information, no-op.
        Args:
            creator:
...
class WeiboDbStoreImplement(AbstractStore):
    ...
    async def store_content(self, content_item: Dict):
        ...
        """
        # Educational version fallback: Filter out deleted/extra fields to ensure user_id/avatar etc. are not passed to ORM
    ...
    async def store_creator(self, creator: Dict):
        ...
        Educational version: Do not collect/persist creator personal information, no-op (WeiboCreator table has been removed).
        Args:
            creator:
