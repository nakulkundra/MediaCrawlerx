...
async def update_xhs_note(note_item: Dict):
    ...
    local_db_item = {
        ...
        "creator_hash": anonymize_user_id(user_info.get("user_id")),  # Creator anonymous hash (does not store original user_id)
...
async def save_creator(user_id: str, creator: Dict):
    ...
    """
    # Educational version: Creator personal profile (nickname/gender/avatar/IP/follower count, etc.) is no longer persisted in the database to prevent harassment.
    return
