...
function result_encrypt(long_str, num = null) {
    let s_obj = {
        ...
        "s1": "Dkdpgh4ZKsQB80/Mfvw36XI1R25+WUAiEi7NLboqYTOPuzmFjJnryx9HVGcaStCe=",
        "s2": "Dkdpgh4ZKsQB80/Mfvw36XI1R25-WUAiEi7NLboqYTOPuzmFjJnryx9HVGcaStCe=",
        "s3": "ckdp1h4ZKsUB80/Mfvw36XIgR25+WQAiEi7NLboqYTOPuzmFjJnryx9HVGDaStCe",
        "s4": "Dkdpgh2ZmsQB80/MfvV36XI1R45-WUAiEixNLwoqYTOPuzKFjJnry79HbGcaStCe"
    }
    let constant = {
        "0": 16515072,
        "1": 258048,
...
function generate_rc4_bb_str(url_search_params, user_agent, window_env_str, suffix = "cus", Arguments = [0, 1, 14]) {
     ...
     * 1: Result of url_search_params after 2 sm3 hashes
     * 2: Result of suffix after 2 sm3 hashes
     * 3: Result after processing ua
     */
    // Result of url_search_params after 2 sm3 hashes
    let url_search_params_list = sm3.sum(sm3.sum(url_search_params + suffix))
    // Result of suffix after 2 sm3 hashes
    ...
    // Result of (url_search_params + "cus") after 2 sm3 hashes
    ...
    // Result of ("cus") suffix after 2 sm3 hashes
    /**
     * let cus = [
    ...
    // Environment detection was performed in between
    // Code index: 2496 Index value: 17 (index 64 key condition)
    // '1536|747|1536|834|0|30|0|0|1536|834|1536|864|1525|747|24|24|Win32'.charCodeAt() gets 65-length array
    /**
